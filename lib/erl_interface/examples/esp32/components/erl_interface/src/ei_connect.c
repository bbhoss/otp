...
/* ESP-IDF uses lwIP for BSD sockets */
#include <unistd.h>
#include <time.h>
#include <sys/time.h>
...
#include <arpa/inet.h>
#include <netdb.h>
#include "esp_random.h"  /* for esp_random() - hardware RNG */
/* No sys/utsname.h or sys/times.h on ESP32 */
...
/* ESP32: Use hardware RNG - much better than POSIX entropy sources */
